          ...
          <ul class="sidebar-menu">
            ...
            <li class="with-sub">
              <a href="#" aria-haspopup="true">
                ...
                <span class="menu-text">Truck Maintenance</span>
              </a>
              <ul class="sidebar-submenu collapse">
            ...
            <li class="with-sub">
              ...
              <ul class="sidebar-submenu collapse">
                ...
                <li class="<?php if($page_name == 'order_reports.php') { echo "active"; } ?>"><a href="order_reports.php" target="_blank">Web Orders</a></li>
              </ul>
            </li>
            <!-- <li class="with-sub">
              <a href="#" aria-haspopup="true">
