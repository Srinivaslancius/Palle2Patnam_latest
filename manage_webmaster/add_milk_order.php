...
if (!isset($_POST['submit']))  {
    ...
    $created_at = date("Y-m-d h:i:s");
  	$sql = "INSERT INTO milk_orders (`user_id`, `product_id`, `total_ltr`,`price_ltr`,`total_ltr_price`, `start_date`, `end_date`, `created_at`) VALUES ('$user_id','$product_id', '$total_ltr','$price_per_ltr','$total_ltr_price','$start_date','$end_date','$created_at')";
              ...
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="total_ltr" name="total_ltr" placeholder="Total ltrs" data-error="Please enter Milk in Ltrs." required>
                    <div class="help-block with-errors"></div>
                  </div>
                  <div class="form-group">
                    <label for="form-control-2" class="control-label">Price per Ltr</label>
                    <input type="text" class="form-control" id="price_ltr" name="price_ltr" placeholder="Price per Ltr" data-error="Please enter Milk in Ltrs." required>
                    <div class="help-block with-errors"></div>
                  </div>
                  <div class="form-group">
                    <label for="form-control-2" class="control-label">Total Price per Ltr</label>
                    <input type="text" class="form-control" id="total_ltr_price" name="total_ltr_price" placeholder="Total Price per Ltr" data-error="Please enter Milk in Ltrs." readonly required>
                    <div class="help-block with-errors"></div>
                  </div>
                  <div class="form-group">
                    <label for="form-control-2" class="control-label">Start Date</label>
                    <input type="text" class="form-control" id="start_date" name="start_date" placeholder="Start Date" data-error="Please enter Start Date." required>
                    <div class="help-block with-errors"></div>
                  </div>
                  <div class="form-group">
                    <label for="form-control-2" class="control-label">End Date</label>
                    <input type="text" class="form-control" id="end_date" name="end_date" placeholder="End Date" data-error="Please enter End Date." required>
                    <div class="help-block with-errors"></div>
                  </div>
