...
<div class="site-content">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="row">
              <?php $getvendors = getDataFromTables('vendors',$status=NULL,'id',$id,$activeStatus=NULL,$activeTop=NULL);
              $getVendors1 = $getvendors->fetch_assoc(); ?>		
                  ...
                  <div class="form-group">
                    ...
                    <select id="form-control-3" name="status" class="custom-select" data-error="This field is required." required>
                      ...
                      <?php while($row = $getStatus->fetch_assoc()) {  ?>
                          <option <?php if($row['id'] == $getVendors1['status']) { echo "Selected"; } ?> value="<?php echo $row['id']; ?>"><?php echo $row['status']; ?></option>
                      <?php } ?>
                   </select>
                    <div class="help-block with-errors"></div>
                  </div>
